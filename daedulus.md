...
i am givig the prompts i used to buikd the frontend for the websites as it is not currenltly and also can you remove the openwebui completely for now we wil redeisgn teh claude app as we kow so mb goes less this below contaisn the videos and frontend for  deadulus enginering platform like its a moutnian of effort you can swap the names and everything so you get the video instead of .png which is better ig then  i will say what to do next    after this work i will share for all the projects  you just need to swap out the images with the urls with little working  and my names and projects accpridng wordings 
