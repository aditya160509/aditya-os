        ...
        <div className={styles.content}>
          ...
          <div className={styles.intro}>
            ...
            <p className={styles.description}>
              I build research-driven systems that turn messy signals into useful decisions —
              from market microstructure and applied ML to interactive software people want to explore.
            </p>
          </div>
