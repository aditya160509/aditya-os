                                        ...
                                        {currentProject ? (
                                            <>
                                                ...
                                                {(currentProject.links as any).live && (
                                                    <a href="https://www.linkedin.com/in/aditya-balaji-50375237a/" target="_blank" rel="noreferrer" className="flex items-center justify-center gap-2 py-2 rounded-lg bg-[var(--bg-activity)] border border-[var(--border)] text-[var(--text-primary)] text-[11px] font-bold hover:bg-[var(--bg-activity)]/80 transition-all">
                                                        <Linkedin size={12} />
                                                        Get in Touch
                                                    </a>
                                                )}
                                            ...
                                            <>
                                                <a href="https://github.com/aditya160509" target="_blank" rel="noreferrer" className="flex items-center justify-center gap-2 py-2 rounded-lg bg-[var(--bg-activity)] border border-[var(--border)] text-[var(--text-primary)] text-[11px] font-bold hover:bg-[var(--bg-activity)]/80 transition-all">
                                                    <Github size={12} />
                                                    GitHub
                                                </a>
                                                <a href="https://www.linkedin.com/in/aditya-balaji-50375237a/" target="_blank" rel="noreferrer" className="flex items-center justify-center gap-2 py-2 rounded-lg bg-[var(--bg-activity)] border border-[var(--border)] text-[var(--text-primary)] text-[11px] font-bold hover:bg-[var(--bg-activity)]/80 transition-all">
                                                ...
                                                <a href="mailto:aditya160509@gmail.com" className="flex items-center justify-center gap-2 py-2 rounded-lg bg-[var(--bg-activity)] border border-[var(--border)] text-[var(--text-primary)] text-[11px] font-bold hover:bg-[var(--bg-activity)]/80 transition-all">
                                                    <Mail size={12} />
                                                    Email
                                                </a>
                                ...
                                <CollapsibleSection title="Connect" icon={LinkIcon}>
                                    <div className="grid grid-cols-1 gap-1.5">
                                        {currentProject ? (
                                            ...
                                            <>
                                                <a href="https://github.com/aditya160509" target="_blank" rel="noreferrer" className="flex items-center gap-2 p-2 hover:bg-[var(--bg-activity)] transition-colors text-[var(--text-secondary)] hover:text-[var(--text-primary)]">
                                                    <Github size={13} />
                                                    <span className="text-[11px] font-sans">GitHub</span>
                                                </a>
                                                <a href="https://www.linkedin.com/in/aditya-balaji-50375237a/" target="_blank" rel="noreferrer" className="flex items-center gap-2 p-2 hover:bg-[var(--bg-activity)] transition-colors text-[var(--text-secondary)] hover:text-[var(--text-primary)]">
                                                    <Linkedin size={13} />
                                                    <span className="text-[11px] font-sans">LinkedIn</span>
                                                </a>
                                                <a href="mailto:aditya160509@gmail.com" className="flex items-center gap-2 p-2 hover:bg-[var(--bg-activity)] transition-colors text-[var(--text-secondary)] hover:text-[var(--text-primary)]">
                                                    <Mail size={13} />
