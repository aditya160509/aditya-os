                                ...
                                <div className="max-w-4xl">
                                    <h1 className="text-3xl md:text-6xl lg:text-7xl font-bold text-[var(--text-primary)] tracking-tight mb-6 leading-[1.1] md:leading-[1.05]">
                                        ...
                                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--hero-gradient-start)] to-[var(--hero-gradient-end)]">
                                            <TypingEffect text="Aditya Balaji" speed={150} />
                                        </span>
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 pt-8 border-t border-[var(--border)]">
                                        {[
                                            { label: "Current Role", value: "Quantitative Researcher", color: "text-[var(--warning)]" },
                                            { label: "Location", value: "Mumbai, India", color: "text-[var(--success)]" },
                                            { label: "Status", value: "Publishing research", color: "text-[var(--info)]" }
                                        ].map((item, idx) => (
                    ...
                    <div className="flex-1 overflow-y-auto custom-scrollbar">
                        <div className="p-8 md:p-12 max-w-5xl mx-auto animate-in fade-in duration-500">
                            <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
                                <div>
                                    <h1 className="text-4xl text-[var(--text-primary)] font-light mb-2">Aditya Balaji's Portfolio</h1>
                                    <p className="text-lg text-[var(--text-secondary)] opacity-70">Quantitative Researcher &amp; Engineer</p>
                                </div>
                                <div className="flex gap-4">
                                    <a href="https://github.com/aditya160509" target="_blank" rel="noopener noreferrer" className="p-2 bg-[var(--bg-activity)] hover:bg-[var(--accent)]/20 border border-[var(--border)] rounded-sm text-[var(--text-secondary)] hover:text-[var(--accent)] transition-all">
                                        <Github size={20} />
                                    </a>
                                    <a href="https://www.linkedin.com/in/aditya-balaji-50375237a/" target="_blank" rel="noopener noreferrer" className="p-2 bg-[var(--bg-activity)] hover:bg-[var(--accent)]/20 border border-[var(--border)] rounded-sm text-[var(--text-secondary)] hover:text-[var(--accent)] transition-all" title="LinkedIn">
                                        <Linkedin size={20} />
                                    </a>
                                </div>
                            </div>
                    ...
                    <div className="p-4 md:p-12 max-w-5xl mx-auto animate-in fade-in zoom-in-95 duration-300 pb-20">
                        ...
                        <div className="pl-4 md:pl-6 border-l-2 border-[var(--border)] space-y-4 font-mono text-xs md:text-base mb-12">
                            ...
                            <div className="flex flex-wrap gap-2 md:gap-4 items-center">
                                ...
                                <span className="text-[var(--text-primary)]">"Quantitative Researcher &amp; Engineer"</span>
                            </div>

                            {/* 2. Location */}
                            <div className="flex flex-wrap gap-2 md:gap-4 items-center">
                                <span className="text-[var(--success)] min-w-[80px] md:min-w-[100px]">location:</span>
                                <span className="text-[var(--text-primary)]">"Mumbai, India"</span>
                            </div>

                            {/* 3. Status */}
                            <div className="flex flex-wrap gap-2 md:gap-4 items-center">
                                <span className="text-[var(--info)] min-w-[80px] md:min-w-[100px]">status:</span>
                                <span className="text-[var(--text-primary)]">"Publishing research, shipping software"</span>
                            </div>
                        ...
                        <div className="flex-1 overflow-y-auto custom-scrollbar">
                            {isPreview ? (
                                <div className="prose prose-invert prose-slate max-w-none font-sans text-[var(--text-primary)]">
                                    <h1 className="flex items-center gap-3 text-3xl font-bold mb-4"><span className="text-4xl">⚙️</span><span>Hi, I’m Aditya Balaji</span></h1>
