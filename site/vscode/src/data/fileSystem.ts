...
**Aditya Balaji's Portfolio** is not just a website; it's a high-performance, browser-based **Visual Studio Code environment** designed to showcase technical expertise through an immersive developer experience. 
...
git clone https://github.com/aditya160509/aditya-os.git
...
`,
  package_json: `
{
  "name": "Aditya Balaji — Code Studio",
  "version": "1.0.0",
  "private": true,
  "dependencies": {
    "react": "^18.2.0",
