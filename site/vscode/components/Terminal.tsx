...
const commands: Record<string, () => string[]> = {
  ...
  about: () => [
    "Hi, I'm Aditya!",
    'I build research-driven software across markets, applied ML,',
    'open-data climate research, and interactive web experiences.',
    'This portfolio is styled like VS Code because that is where the work happens.',
  ],
  skills: () => [
    'Technical Skills:',
    ...
    '  Research:   Econometrics, Monte Carlo, applied ML',
    '  Tools:      Git, Vercel, Render, Figma',
  ],
  projects: () => [
    'Featured Projects:',
    '  1. AdityaOS - an interactive 3D workstation portfolio',
    '  2. ATLAS / QUANT360 - quantitative research platform',
    '  3. NEXUS Exchange - agent-based market simulator',
    '  4. PhenoSync - climate mismatch research pipeline',
    '',
  ...
  contact: () => [
    ...
    '  GitHub:   github.com/aditya160509',
    '  LinkedIn: linkedin.com/in/aditya-balaji-50375237a',
  ],
  themes: () => [
    'Available themes:',
  ...
  ls: () => ['about/', 'projects/', 'research/', 'contact/', 'README.md'],
  pwd: () => ['/home/aditya/code-studio'],
};
...
const Terminal = ({ onToggle }: TerminalProps) => {
  const [lines, setLines] = useState<TerminalLine[]>([
    { type: 'output', content: 'Aditya Balaji — interactive Code Studio terminal' },
