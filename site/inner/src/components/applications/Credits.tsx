...
const CREDITS = [
    {
        ...
        rows: [['Aditya Balaji', 'All']],
    },
    {
        title: 'Modeling & Texturing',
        rows: [
            ['Aditya Balaji', 'Texturing, Composition, & UV'],
    ...
    },
    {
        title: 'Sound Design',
        rows: [
            ['Aditya Balaji', 'Mixing, Composition, & Foley'],
...
const Credits: React.FC<CreditsProps> = (props) => {
    ...
    return (
        ...
        <Window
            ...
            bottomLeftText={'© Copyright 2026 Aditya Balaji'}
        >
            <div
