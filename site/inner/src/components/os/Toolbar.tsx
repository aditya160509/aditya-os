...
const Toolbar: React.FC<ToolbarProps> = ({
    ...
    const getTime = () => {
        const date = new Date();
        const clock24 = localStorage.getItem('clock24') === '1';
                ...
                >
                    <div style={styles.startWindowInner}>
                        <div style={styles.verticalStartContainer}>
                            <p style={styles.verticalText}>AdityaOS</p>
                        </div>
            ...
            <div className="desktop-toolbar-inner" style={styles.toolbarInner}>
                    ...
                    <div style={styles.toolbarTabsContainer}>
                        {[
                            ...
                            <div
                                ...
                                title={`Open ${q.key}`}
                                onMouseDown={() => {
                                    window.dispatchEvent(new CustomEvent('aditya-open-app', { detail: { key: q.key } }));
                                }}
                            >
                                <Icon size={18} icon={q.icon} style={styles.tabIcon} />
                            </div>
                        ))}
                ...
                <div className="desktop-toolbar-time" style={styles.time}>
                    <p
                        ...
                        onMouseDown={() => {
                            try {
                                const doc: any = window.top?.document || document;
